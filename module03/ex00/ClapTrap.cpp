...
/* CONSTRUCTORS */
ClapTrap::ClapTrap ( void ) : _name("Unnamed"), _hit_pts(10), _energy_pts(10), _attack_damage(0) {
	std::cout << "Default constructor called" << std::endl;
	this->displayData("ClapTrap ");
	return ;	
};
...
void ClapTrap::attack(const std::string& target) {
	...
	if (this->_hit_pts > 0 && this->_energy_pts > 0)
	{
		...
		if (target != "")
			...
			std::cout << this->_name << " attacks machin, causing " << this->_attack_damage << " points of damage !" << std::endl;
