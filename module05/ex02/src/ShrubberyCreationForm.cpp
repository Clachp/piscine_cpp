...
/* CONSTRUCTORS */
ShrubberyCreationForm::ShrubberyCreationForm() : A_Form("SCF", 145, 137), _target("target X") {
...
ShrubberyCreationForm::ShrubberyCreationForm(std::string target) : A_Form("SCF", 145, 137), 
_target(target) {
